...
## Project Structure
    ...
    ├── testapiautoteammemb_56952  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_56952`
...
2. Clone this repo and `cd testapiautoteammemb_56952`
